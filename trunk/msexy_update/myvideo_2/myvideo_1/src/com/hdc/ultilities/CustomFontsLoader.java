...
public class CustomFontsLoader {
	...
	// set font for textview BOLD
	public static void setFont_Bold(TextView v, int typeFont, Context context) {
		// v.setTypeface(getTypeface(context, typeFont), Typeface.BOLD);
