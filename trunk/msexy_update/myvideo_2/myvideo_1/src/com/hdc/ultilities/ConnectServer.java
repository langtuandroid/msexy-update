...
public class ConnectServer {
	...
	// get List video HOT
	public void getListVideo_HOT_1() {
		String m_Info = "token" + Equals + TOKEN + And + "p" + Equals + pageCurrent;
		String Info_Base64 = Base64.encode(m_Info.getBytes());
	...
	// get List video NEW
	public void getListVideo_NEW_1() {
		String m_Info = "token" + Equals + TOKEN + And + "p" + Equals + pageCurrent;
	...
	// get List video HOT
	public void getListVideo_TOP_1() {
		String m_Info = "token" + Equals + TOKEN + And + "p" + Equals + pageCurrent;
		...
		try {
			...
			try {
				...
				if (!m_Promotion.getSrc().equals("")) {
					Bitmap b = null;
					b = DownloadImage.instance.getImage(m_Promotion.getSrc());
	...
	// get data
	public static Data getData_1(String data) {
		Data p1 = new Data();
		try {
			JSONObject json = new JSONObject(data);
			p1.setTotalPage(Integer.parseInt(json.getString("totalPage")));
	...
	public void getSMS() {
		...
		try {
			...
			/*
			 * m_Sms.mo = json.getString("mo"); m_Sms.message =
			 * json.getString("message"); JSONArray array = new
			 * JSONArray(json.getString("serviceCode")); for(int i = 0 ; i <
			 * array.length();i++){
			 * m_Sms.m_ListServiceCode.add(array.getString(i)); } m_Sms.index =
			 * 0; m_Sms.serviceCode = m_Sms.m_ListServiceCode.get(m_Sms.index);
			 */
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
