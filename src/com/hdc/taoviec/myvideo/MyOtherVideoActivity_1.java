...
public class MyOtherVideoActivity_1 extends Activity implements OnClickListener, Runnable,
	...
	private static MyOtherVideoActivity_1 instance;
	private int time = 0;
...
//		txtTitle.setText(title);
	...
	public void initAlertDialog_Success_Fail() {
		AlertDialog.Builder builder = new AlertDialog.Builder(MyOtherVideoActivity_1.this);
